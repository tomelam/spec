...
;(function (root, Spec) {
  ...
  all = exports.all = (function () {
    ...
    for (property in memo) {
      ...
      if (exports.hasKey(memo, property)) {
        size += 1;
      }
    }
    ...
    if (!size) {
      ...
      all = function all(object, callback) {
        ...
        for (property in object) {
          if (exports.hasKey(object, property) && !callback(property, object[property], object)) {
            return false;
          }
        }
      ...
      all = function all(object, callback) {
        ...
        for (property in object) {
          ...
          if (!(isFunction && property === "prototype") && !exports.hasKey(memo, property) && (memo[property] = 1) && exports.hasKey(object, property) && !callback(property, object[property], object)) {
            return false;
          }
        }
        return true;
      ...
      all = function all(object, callback) {
        ...
        for (property in object) {
          if (!(isFunction && property === "prototype") && exports.hasKey(object, property) && !(isConstructor = property === "constructor") && !callback(property, object[property], object)) {
            return false;
          }
        }
        // Manually invoke the callback for the `constructor` property due to
        // cross-environment inconsistencies.
        return (isConstructor || exports.hasKey(object, "constructor")) ? !!callback("constructor", object.constructor, object) : true;
      };
    }
    return all;
  })(),
    ...
    function eq(left, right, stack) {
      ...
      if (className == "[object Array]") {
        ...
        result = all(left, function (key, value) {
          ...
          return exports.hasKey(right, key) && eq(value, right[key], stack);
        });
  ...
  function emit(event) {
    ...
    if (!exports.hasKey(event, "target")) {
      event.target = this;
    }
