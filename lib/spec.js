...
;(function (root, Spec) {
  ...
  isPropertyOf = exports.isPropertyOf = (function () {
    ...
    // The `__proto__` property can't be set more than once in Gecko. The
    // parenthesized expression prevents an unsafe transformation by the
    // Closure Compiler.
    Environment.mutableProto = (memo.__proto__ = nil, memo.__proto__ = { 1: 2 }, memo)[1] == 2;
    memo = nil;
    ...
    if ((Environment.hasOwnProp = getClass.call(hasOwnProperty) == "[object Function]")) {
      ...
      isPropertyOf = function isPropertyOf(object, property) {
        ...
        // Prevents another unsafe transformation by the Closure Compiler.
  ...
  all = exports.all = (function () {
    ...
    for (property in memo) {
      ...
      if (exports.isPropertyOf(memo, property)) {
        size += 1;
      }
    }
    ...
    if (!size) {
      ...
      all = function all(object, callback) {
        ...
        for (property in object) {
          if (exports.isPropertyOf(object, property) && !callback(property, object[property], object)) {
            return false;
          }
        }
      ...
      all = function all(object, callback) {
        ...
        for (property in object) {
          ...
          if (!(isFunction && property === "prototype") && !exports.isPropertyOf(memo, property) && (memo[property] = 1) && exports.isPropertyOf(object, property) && !callback(property, object[property], object)) {
            return false;
          }
        }
        return true;
      ...
      all = function all(object, callback) {
        ...
        for (property in object) {
          if (!(isFunction && property === "prototype") && exports.isPropertyOf(object, property) && !(isConstructor = property === "constructor") && !callback(property, object[property], object)) {
            return false;
          }
        }
        // Manually invoke the callback for the `constructor` property due to
        // cross-environment inconsistencies.
        return (isConstructor || exports.isPropertyOf(object, "constructor")) ? !!callback("constructor", object.constructor, object) : true;
      };
    }
    return all;
  })(),
    ...
    function eq(left, right, stack) {
      ...
      if (className == "[object Array]") {
        ...
        result = all(left, function (key, value) {
          ...
          return exports.isPropertyOf(right, key) && eq(value, right[key], stack);
        });
  ...
  function emit(event) {
    ...
    if (!exports.isPropertyOf(event, "target")) {
      event.target = this;
    }
