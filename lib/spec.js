...
(function() {
  ...
  Spec.Test.prototype.ok = function(expression, data) {
    var event = {
      'actual': expression,
      'expected': true
    };
    if (typeof data == 'object' && data) {
      ...
      if ('actual' in data) event.actual = data.actual;
      if ('expected' in data) event.expected = data.expected;
      event.message = typeof data.message == 'string' && data.message || 'ok';
    } else {
      event.message = typeof data == 'string' && data || 'ok';
    }
