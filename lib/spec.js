    ...
    if (!size) {
      ...
      all = function all(object, callback, context) {
        ...
        for (property in object) {
          if (hasKey(object, property) && !call.call(callback, context, property, object[property], object)) {
            return false;
          }
        }
      ...
      all = function all(object, callback, context) {
        ...
        for (property in object) {
          ...
          if (!(isFunction && property === "prototype") && !hasKey(memo, property) && (memo[property] = 1) && hasKey(object, property) && !call.call(callback, context, property, object[property], object)) {
            return false;
          }
        }
        return true;
      ...
      all = function all(object, callback, context) {
        ...
        isFunction = getClass.call(object) == "[object Function]";
        for (property in object) {
          if (!(isFunction && property === "prototype") && hasKey(object, property) && !(isConstructor = property === "constructor") && !call.call(callback, context, property, object[property], object)) {
            return false;
          }
        }
        // Manually invoke the callback for the `constructor` property due to
        // cross-environment inconsistencies.
        return (isConstructor || hasKey(object, "constructor")) ? !!call.call(callback, context, "constructor", object.constructor, object) : true;
      };
    }
    return all;
  })(),
  ...
  function emit(event) {
    ...
    if ((target = this.events[event.type])) {
      for (previous = target.previous; (target = target.next) != previous;) {
        ...
        try {
          call.call(target.callback, target.context || this, event);
        } catch (exception) {
          error = exception;
    ...
    if (all) {
      for (previous = all.previous; (all = all.next) != previous;) {
        try {
          call.call(all.callback, all.context || this, event);
        } catch (exception) {
          error = exception;
          defer(function () {
            throw error;
