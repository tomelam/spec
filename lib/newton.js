        ...
        switch (type) {
          ...
          case "start":
            ...
            Spec.forOwn((this.elements = {
              "header": buildNode("h1", { "className": "suiteHeader" }, [document.createTextNode(this.name)]),
              // Representing the status of the suite (e.g., running, passed, failed).
              "status": buildNode("div", { "className": "suiteStatus suiteRunning" }),
              // Contains the aggregate suite results.
              "results": buildNode("ol", { "className": "testList" }),
              // Contains the aggregate suite summary.
              "stats": buildNode("p", { "className": "suiteSummary" }, [document.createTextNode("Running...")])
