...
(function (root, Maddy) {
  ...
  getClassOf = exports["getClassOf"] = (function () {
    function getClassOf(object) {
      ...
      // Look up the `[[Class]]` names of objects using `Object::toString`. `"Object"` is used as
      // the default if the `[[Class]]` name is not specified in the map.
    ...
    // stored in the `[[Class]]` map along with their corresponding `Object::toString` equivalents
    // for object wrappers.
  ...
  // **map** returns an object containing the results of invoking a callback function on each object
  // member. Aliased as **collect**.
